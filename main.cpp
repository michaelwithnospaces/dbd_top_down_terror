...
int main(void)
{
    ...
    InitWindow(screenWidth, screenHeight, "Dead by Daylight: Top-Down Terror");
    ...
    Generator generator((Vector2){ 400, 300 }, generatorFrames, 0.05f); // Adjust frame time as needed
